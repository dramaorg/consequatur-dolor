# @dramaorg/consequatur-dolor

[![NPM Package Version](https://img.shields.io/npm/v/@dramaorg/consequatur-dolor)](https://www.npmjs.com/package/@dramaorg/consequatur-dolor)
[![Build Status](https://github.com/dramaorg/consequatur-dolor/workflows/CI/badge.svg)](https://github.com/dramaorg/consequatur-dolor/actions?query=workflow%3ACI)
...
```
npm i @dramaorg/consequatur-dolor
```
...
const SonicBoom = require('@dramaorg/consequatur-dolor')
...
* `retryEAGAIN(err, writeBufferLen, remainingBufferLen)`: a function that will be called when @dramaorg/consequatur-dolor
    write/writeSync/flushSync encounters a EAGAIN or EBUSY error. If the return value is
    true @dramaorg/consequatur-dolor will retry the operation, otherwise it will bubble the
    error. `err` is the error that caused this function to be called,
    `writeBufferLen` is the length of the buffer @dramaorg/consequatur-dolor tried to write, and
    `remainingBufferLen` is the length of the remaining buffer @dramaorg/consequatur-dolor didn't try to write.
